...
int main()
{
    ...
    while (!WindowShouldClose()) {
        ...
        if (game.gameOver) {
            ...
            DrawRectangleRounded({ (235 - 215.5) / 2, (300 - 38) / 2, 215.5 + 10, 38 + 5 }, (float)0.3, 6, lightPurpleBackground);
            DrawTextEx(font, "P TO PLAY/PAUSE\n\n\n\nUP TO ROTATE\n\n\n\nLEFT/RIGHT TO MOVE\n\n\n\nC TO HOLD", { (245 - 215.5) / 2, (310 - 38) / 2 }, 23,1, RAYWHITE);
        }
        EndDrawing();
    }
    CloseWindow();
